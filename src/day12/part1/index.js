...
class Ship {
    ...
    get manhattanDistance() {
        const horizontal = Math.max(this.coords.east, this.coords.west) - Math.min(this.coords.east, this.coords.west);
        const vertical = Math.max(this.coords.north, this.coords.south) - Math.min(this.coords.north, this.coords.south);
    ...
    turn(direction, degrees) {
        ...
        let newDirectionIndex = direction === 'R' ? directions.indexOf(this.direction) + turnsToMake: directions.indexOf(this.direction) - turnsToMake;
