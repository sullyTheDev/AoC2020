...
class Ship {
  ...
  get manhattanDistance() {
    const horizontal =
      Math.max(this.shipCoords.east, this.shipCoords.west) -
      Math.min(this.shipCoords.east, this.shipCoords.west);
    const vertical =
      Math.max(this.shipCoords.north, this.shipCoords.south) -
      Math.min(this.shipCoords.north, this.shipCoords.south);
